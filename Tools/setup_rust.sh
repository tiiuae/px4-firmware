...
rustup target add --toolchain stable-x86_64-unknown-linux-gnu aarch64-unknown-none

rustup toolchain install 1.81.0-x86_64-unknown-linux-gnu
rustup target add --toolchain 1.81.0-x86_64-unknown-linux-gnu riscv64gc-unknown-none-elf
cargo install --force bindgen-cli@0.70.1
