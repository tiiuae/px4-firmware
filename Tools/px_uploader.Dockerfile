ARG saluki_pi_version
ARG saluki_v2_version

FROM ghcr.io/tiiuae/saluki-pi-fpga:$saluki_pi_version AS SALUKI_PI
FROM ghcr.io/tiiuae/saluki-pi-fpga:$saluki_v2_version AS SALUKI_V2
